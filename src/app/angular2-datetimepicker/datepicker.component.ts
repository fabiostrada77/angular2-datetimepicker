...
export class DatePicker implements OnInit, ControlValueAccessor {
    ...
    defaultSettings: Settings = {
        ...
        cal_days_labels: ['Do', 'Lu', 'Ma', 'Me', 'Gi', 'Ve', 'Sa'],
        cal_full_days_lables: ["Domenica", "Lunedì", "Martedì", "Mercoledì", "Giovedì", "Venerdì", "Sabato"],
        cal_months_labels: ['Gennaio', 'Febbraio', 'Marzo', 'Aprile',
            'Maggio', 'Giugno', 'Luglio', 'Agosto', 'settembre',
            'Ottobre', 'Novembre', 'Dicembre'],
        cal_months_labels_short: ['GEN', 'FEB', 'MAR', 'APR',
            'MAG', 'GIU', 'LUG', 'AGO', 'SET',
            'OTT', 'NOV', 'DIC'],   
        closeOnSelect: true,
        rangepicker: false
